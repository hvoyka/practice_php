...
<div id="wrapper">
    ...
    <div id="page-bgtop">
      <div id="content">
       ...
       <?php foreach($newsList as $newsItem):?>
        <div class="post">
          <h2 class="title"><a href="/MVC/news/<?=$newsItem['id'];?>"><?=$newsItem['title'];?></a></h2>
          <p class="byline"><?=$newsItem['date'];?></p>
          <div class="entry">
            <p><?=$newsItem['short_content'];?></p>
          </div>
          <div class="meta">
            <p class="links"><a href="/MVC/news/<?=$newsItem['id'];?>" class="comments">Read more</a></p>
          </div>
        </div>
       <?php endforeach;?>
  ...
  <!-- end div#page -->
  <div id="footer">
    <p>Copyright &copy; 2007 Culinary. All Rights Reserved. Designed by <a href="http://www.freecsstemplates.org">FCT</a>.&nbsp;&nbsp;<a href="#">Privacy Policy</a> | <a href="#">Terms of Use</a></p>
  </div>
  <!-- end div#footer -->
</div>
<!-- end div#wrapper -->
